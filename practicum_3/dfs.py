...
if __name__ == "__main__":
    ...
    G = nx.read_edgelist("c:/Users/Lada/python/practicum_3/graph_2.edgelist", create_using=nx.Graph)
    plot_graph(G)
    ...
    G = nx.read_edgelist("c:/Users/Lada/python/practicum_3/graph_2.edgelist", create_using=nx.DiGraph)
    plot_graph(G)
