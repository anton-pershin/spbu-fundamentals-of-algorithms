...
**План**
1. Изучить примеры вычислительной неустойчивости и реализовать устойчивые схемы вычислений (схема Горнера, алгоритм Кэхэна) в файле `practicum_9/numerical_stability.py`.
2. Реализовать LU-разложение в файле `practicum_9/lu.py`.
3. Реализовать разложение Холецкого в файле `practicum_9/cholesky.py`.

**Домашнее задание**
1. [Реализовать LU разложение с выбором главного элемента](practicum_9/homework). Дедлайн: 2026.05.22 23:59. 
>>>>>>> upstream/main
